...
<div id="content">
                ...
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">ADD YOUR CV LIST BELOW</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo base_url();?>super_admin/save_cv" method="post" onsubmit="return validateStandard(this)">
                                        <div class="form-group">
                                            <label>Input cv list</label>
