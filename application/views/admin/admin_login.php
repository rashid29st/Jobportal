   ...
   <!-- PAGE CONTENT --> 
    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active">
            <form action="<?php echo base_url();?>admin/check_admin_login" method="post" class="form-signin">
                ...
                <input type="text" placeholder="Username" class="form-control" name="admin_email_address"/>
