                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo base_url();?>super_admin/update_job_list" method="post" onsubmit="return validateStandard(this)">
                                        <div class="form-group">
                                            <label>Input name of job</label>
                                            <input class="form-control" placeholder="Enter text" type="text" name="list_name" err="no number is allowed" required regexp="JSVAL_RX_ALPHA"value="<?php echo $all_list->list_name?>">
                                            <input type="hidden" name="list_id" value="<?php echo $all_list->list_id ;?>"
