...
<!--                                        <th>Engine version</th>-->
    ...
    <!--                                            <td class="center">4</td>-->
                        ...
                        {
                    ?>
                                                <a class=".col-lg-3" href="<?php echo base_url();?>super_admin/delete_list_detail/<?php echo $v_category->job_id?>" title="DELETE" onclick="return check_delete();">
