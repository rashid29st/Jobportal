            ...
            <div class="border-left">
                <div class="left-top-corner">
                    <div class="right-top-corner">
                        <div class="inner">
                            <h2><span>POST YOUR</span> OFFER</h2>
                            ...
                            <form id="contacts-form" action="<?php echo base_url(); ?>welcome/save_job_list_details" method="post" onsubmit="return validateStandard(this)">
                                <fieldset>
